...
router.post("/forgot-password", authController.forgotUserPassword.bind(authController));
router.post("/verify-forgot-password-otp", authController.verifyForgotPasswordOtp.bind(authController));
router.post("/reset-password", authController.resetUserPassword.bind(authController));
router.get("/check-session",authenticate, authController.checkSession.bind(authController));
router.get("/refresh-token", authController.refreshToken.bind(authController));
router.get("/logout", authenticate,authController.logoutUser.bind(authController));

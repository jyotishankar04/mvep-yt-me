...
import { checkOtpRestriction, deleteSession, getUserFromResetToken, getUserFromToken, persistUser, resetPasswordToken, sendOtp, trackOtpRequest, verifyOtp } from "../utils/auth.helper";
import bcrypt from "bcryptjs";
import { generateSessionId, generateTokens, RefreshTokenPayload, rotateTokens, setAuthCookies, verifyRefreshToken } from "../utils/token.helper";
...
class AuthController {
    async userRegistration(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            await sendOtp(validate.data.name, validate.data.email, "user-activation-mail");
